...
def hourglass_refinement(netIN_1,netIN_2,netIN_3,netIN_4,netIN_5,training):
	...
	def hourglass_stack_fused_depth_prediction(stack_in):
		...
		c6 = conv_layer(p3,layer_name('conv'),KER_SZ,NUM_CH[4],bn=bn,training=training)  #shape:[1,256,256,1024] B,H,W,C
		...
		# c10 = conv_layer(c9,layer_name('conv'),KER_SZ,NUM_CH[2],bn=bn,training=training) #shape:[1,256,256,256] B,H,W,C
