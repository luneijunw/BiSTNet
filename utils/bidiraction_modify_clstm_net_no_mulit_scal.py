...
def hourglass_refinement(netIN_1,netIN_2,netIN_3,netIN_4,netIN_5,training):
	...
	def fusion_(F):
		...
		c3 = conv_layer(r0,layer_name('conv'),KER_SZ,NUM_CH[3],bn=bn,training=training)
		...
		c5 = conv_layer(r1,layer_name('conv'),KER_SZ,NUM_CH[2],bn=bn,training=training)
		...
		c7= conv_layer(r2,layer_name('conv'),KER_SZ,NUM_CH[1],bn=bn,training=training)
		...
		c15 = conv_layer(r3,layer_name('conv'),KER_SZ,NUM_CH[0],bn=bn,training=training)
	...
	def Bidi_CLSTM():#f_d.shape=[10,256,256,64]
		...
		# print(3/0)
		a1,F1=attention(f1f,f1b);out1=fusion_(F1)
		a2,F2=attention(f2f,f2b);out2=fusion_(F2)
		a3,F3=attention(f3f,f3b);out3=fusion_(F3)
		a4,F4=attention(f4f,f4b);out4=fusion_(F4)
		a5,F5=attention(f5f,f5b);out5=fusion_(F5)
		# print('F1.shape')
		# print(out1.shape) #(1, 16, 16, 1024)
		# print(3/0)
