...
def hourglass_order_refinement(netIN,training):
	print('-'*30)
	...
	bn = True
	def hourglass_stack_fused_order_depth_prediction(stack_in):
	...
	out0_d = hourglass_stack_fused_order_depth_prediction(netIN)
	return out0_d
