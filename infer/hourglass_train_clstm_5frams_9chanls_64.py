...
def hourglass_refinement(netIN_1,netIN_2,netIN_3,netIN_4,netIN_5,training):
	...
	def R_3(input_cat):
		x0=conv_layer_nobias(input_cat,layer_name('conv'),3,128,bn=bn,training=training)
		x1=conv_layer_nobias(x0,layer_name('conv'),3,128,bn=bn,training=training)
		h=conv_layer(x1,layer_name('conv'),3,64,bn=False,relu=False)
	...
	def R_CLSTM_5(f_d1,f_d2,f_d3,f_d4,f_d5): #f_d.shape=[10,256,256,64]
		...
		h_state_init = tf.zeros([1, h, w, 64])
		c_state_init = tf.zeros([1, h, w, 64])
		# seq_len = 5
		...
		F_t1=conv_layer_sigmoid(input_cat1,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # F_t.shape [2,256,256,8]
		I_t1=conv_layer_sigmoid(input_cat1,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # I_t.shape [2,256,256,8]
		C_t1=conv_layer_tanh(input_cat1,layer_name('conv'),KER_SZ,64,bn=False,training=False,tanh=True)      # C_t.shape [2,256,256,8]
		...
		F_t2=conv_layer_sigmoid(input_cat2,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # F_t.shape [2,256,256,8]
		I_t2=conv_layer_sigmoid(input_cat2,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # I_t.shape [2,256,256,8]
		C_t2=conv_layer_tanh(input_cat2,layer_name('conv'),KER_SZ,64,bn=False,training=False,tanh=True)      # C_t.shape [2,256,256,8]
		...
		F_t3=conv_layer_sigmoid(input_cat3,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # F_t.shape [2,256,256,8]
		I_t3=conv_layer_sigmoid(input_cat3,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # I_t.shape [2,256,256,8]
		C_t3=conv_layer_tanh(input_cat3,layer_name('conv'),KER_SZ,64,bn=False,training=False,tanh=True)      # C_t.shape [2,256,256,8]
		...
		F_t4=conv_layer_sigmoid(input_cat4,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # F_t.shape [2,256,256,8]
		I_t4=conv_layer_sigmoid(input_cat4,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # I_t.shape [2,256,256,8]
		C_t4=conv_layer_tanh(input_cat4,layer_name('conv'),KER_SZ,64,bn=False,training=False,tanh=True)      # C_t.shape [2,256,256,8]
		...
		F_t5=conv_layer_sigmoid(input_cat5,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # F_t.shape [2,256,256,8]
		I_t5=conv_layer_sigmoid(input_cat5,layer_name('conv'),KER_SZ,64,bn=False,training=False,sigmoid=True)   # I_t.shape [2,256,256,8]
		C_t5=conv_layer_tanh(input_cat5,layer_name('conv'),KER_SZ,64,bn=False,training=False,tanh=True)      # C_t.shape [2,256,256,8]
