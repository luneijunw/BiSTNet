...
def hourglass_refinement(netIN_1,netIN_2,netIN_3,netIN_4,netIN_5,training):
	...
	def R_CLSTM_5(f_d1,f_d2,f_d3,f_d4,f_d5): #f_d.shape=[10,256,256,64]
		...
		# print('1',F_t1.shape,I_t1.shape,C_t1.shape,Q_t1.shape,c_state1.shape,h_state1.shape, p_depth1.shape )
		...
		# print('2',F_t2.shape,I_t2.shape,C_t2.shape,Q_t2.shape,c_state2.shape,h_state2.shape, p_depth2.shape )
		...
		# print('3',F_t3.shape,I_t3.shape,C_t3.shape,Q_t3.shape,c_state3.shape,h_state3.shape, p_depth3.shape )
		...
		# print('5',F_t5.shape,I_t5.shape,C_t5.shape,Q_t5.shape,c_state5.shape,h_state5.shape, p_depth5.shape )
