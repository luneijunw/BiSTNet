...
from net_clstm_twoside_2023 import hourglass_refinement
...
# pre_ck_pnts_dir_DR ='/data/liqianlin/HDNET_code/training/surr_tiktok_order_model/20221009_train_progress_5frams_9chanls_0.1_changemodel/model/HDNet' #1009 34
...
pre_ck_pnts_dir_DR ='/data/liqianlin/HDNET_code/training/surr_tiktok_order_model/20230131_clstm_twoside_5frames/model/HDNet/'


sec_path='/2023_lianxu_clstm_600000/'
third_path='600000'
...
for f in tang_mat:
    ...
    # data_name1 = test_files[f+1]
    # data_name2 = test_files[f+2]
    # data_name3 = test_files[f+3]
    # data_name4 = test_files[f+4]
    # print(f)
    # print(f[0])
    ...
    # if data_name==data_name1 and data_name1==data_name2:
    #     continue
    ...
    prediction11,prediction21,prediction31,prediction41,prediction5 = sess.run([out2_1,out2_2,out2_3,out2_4,out2_5],feed_dict={x1:X_1,x2:X_12,x3:X_13,x4:X_14,x5:X_15})
    prediction12,prediction22,prediction32,prediction52,prediction4 = sess.run([out2_1,out2_2,out2_3,out2_4,out2_5],feed_dict={x1:X_1,x2:X_12,x3:X_15,x4:X_13,x5:X_14})
    prediction13,prediction23,prediction53,prediction43,prediction3 = sess.run([out2_1,out2_2,out2_3,out2_4,out2_5],feed_dict={x1:X_1,x2:X_15,x3:X_14,x4:X_12,x5:X_13})
    ...
    if hunhe:
        ...
        if data_name.startswith('a_'):
            write_matrix_txt(image5*Z4[0,...,0],Vis_dir+data_name4+".txt")
            ...
            plt.imsave(save_depth_path+data_name4+".png", depth_map4, cmap="hot") 
            d = np.array(scipy.misc.imread(save_depth_path+data_name4+".png"),dtype='f')
            d = np.where(Z3[0,...]>0,d[...,0:3],255.0);d=Image.fromarray(np.uint8(d))
            d.save(save_depth_path_white+data_name4+".png")
        else:
            # if m/5<453:
            loss1 = comp_deptherr(ZB,gt_depth_path,data_name,image,Z,Z3,imagen)
            loss2 = comp_deptherr(ZB1,gt_depth_path,data_name1,image2,Z1,Z31,imagen2)
            ...
            # write_matrix_txt(image2*Z1[0,...,0],Vis_dir+data_name1+".txt")
            # write_matrix_txt(image3*Z2[0,...,0],Vis_dir+data_name2+".txt")
            # write_matrix_txt(image4*Z333[0,...,0],Vis_dir+data_name3+".txt")
            # write_matrix_txt(image5*Z4[0,...,0],Vis_dir+data_name4+".txt")
            ...
            # plt.imsave(save_depth_path+data_name1+".png", depth_map1, cmap="hot")
            # d = np.array(scipy.misc.imread(save_depth_path+data_name1+".png"),dtype='f')
            # d = np.where(Z31[0,...]>0,d[...,0:3],255.0);d=Image.fromarray(np.uint8(d))
            # d.save(save_depth_path_white+data_name1+".png")
            ...
            # plt.imsave(save_depth_path+data_name2+".png", depth_map2, cmap="hot") 
            # d = np.array(scipy.misc.imread(save_depth_path+data_name2+".png"),dtype='f')
            # d = np.where(Z32[0,...]>0,d[...,0:3],255.0);d=Image.fromarray(np.uint8(d))
            # d.save(save_depth_path_white+data_name2+".png")
            ...
            # plt.imsave(save_depth_path+data_name3+".png", depth_map3, cmap="hot") 
            # d = np.array(scipy.misc.imread(save_depth_path+data_name3+".png"),dtype='f')
            # d = np.where(Z33[0,...]>0,d[...,0:3],255.0);d=Image.fromarray(np.uint8(d))
            # d.save(save_depth_path_white+data_name3+".png")
            ...
            # d = np.where(Z3[0,...]>0,d[...,0:3],255.0);d=Image.fromarray(np.uint8(d))
            # d.save(save_depth_path_white+data_name4+".png")
    # if os.path.isfile(Vis_dir+data_name+".txt"):
    # write_matrix_txt(image*Z[0,...,0],Vis_dir+data_name+'_depth'+".txt")
        # data_name=data_name+'_'+str(m-4)
    # else:
    # write_matrix_txt(image*Z[0,...,0],Vis_dir+data_name+'_depth'+".txt")
    # if os.path.isfile(Vis_dir+data_name1+".txt"):
        # write_matrix_txt(image2*Z1[0,...,0],Vis_dir+data_name1+'_'+str(m-3)+".txt")
        # data_name1=data_name1+'_'+str(m-3)
    # else:
    # write_matrix_txt(image2*Z1[0,...,0],Vis_dir+data_name1+'_depth'+".txt")
    # if os.path.isfile(Vis_dir+data_name2+".txt"):
        # write_matrix_txt(image3*Z2[0,...,0],Vis_dir+data_name2+'_'+str(m-2)+".txt")
        # data_name2=data_name2+'_'+str(m-2)
    # else:
    # write_matrix_txt(image3*Z2[0,...,0],Vis_dir+data_name2+'_depth'+".txt")
    # if os.path.isfile(Vis_dir+data_name3+".txt"):
        # write_matrix_txt(image4*Z333[0,...,0],Vis_dir+data_name3+'_'+str(m-1)+".txt")
        # data_name3=data_name3+'_'+str(m-1)
    # else:
    # write_matrix_txt(image4*Z333[0,...,0],Vis_dir+data_name3+'_depth'+".txt")
    # if os.path.isfile(Vis_dir+data_name4+".txt"):
        # write_matrix_txt(image5*Z4[0,...,0],Vis_dir+data_name4+'_'+str(m)+".txt")
        # data_name4=data_name4+'_'+str(m)
    # else:
    # write_matrix_txt(image5*Z4[0,...,0],Vis_dir+data_name4+'_depth'+".txt")

    
    # print("loss:  %g ,%g ,%g ,%g ,%g ,%g ,%g ,%g ,%g ,%g " % (loss1,loss2,loss3,loss4,loss4,loss6,loss7,loss8,loss9,loss10))
