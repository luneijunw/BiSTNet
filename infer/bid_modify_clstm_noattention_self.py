...
def hourglass_refinement(netIN_1,netIN_2,netIN_3,netIN_4,netIN_5,training):
	...
	def Bidi_CLSTM():#f_d.shape=[10,256,256,64]
		...
		F1 = tf.concat([f1f,f1b],3);out1=fusion(c11,c12,c13,c14,F1)
		F2 = tf.concat([f2f,f2b],3);out2=fusion(c21,c22,c23,c24,F2)
		F3 = tf.concat([f3f,f3b],3);out3=fusion(c31,c32,c33,c34,F3)
		F4 = tf.concat([f4f,f4b],3);out4=fusion(c41,c42,c43,c44,F4)
		F5 = tf.concat([f5f,f5b],3);out5=fusion(c51,c52,c53,c54,F5)
