...
from hourglass_net_depth_oneframe import hourglass_refinement
# from hourglass_train_5fram_9chanls import hourglass_refinement 
# from hourglass_train_clstm_5frams_9chanls_64 import hourglass_refinement 
# from hourglass_train_clstm_5frams_9chanls_8 import hourglass_refinement 
from hourglass_net_normal_oneframe import hourglass_normal_prediction
from utils import (write_matrix_txt,get_origin_scaling,get_concat_h, depth2mesh, read_test_data_9_channals_tang,read_test_data_9_channals_tang,read_test_data_9_channals_thuman, nmap_normalization, get_test_data_9_channals_thuman,get_test_data_9_channals_tang) 
os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID" 
os.environ["CUDA_VISIBLE_DEVICES"]="0"
############################## test path and outpath ##################################
# data_main_path = '/data/liqianlin/HDNET_code/Evaluaton/Thuman_test_result'
...
# data_main_path = '/data/liqianlin/HDNET_code/Evaluaton/tang_test_result_1300_256'
# pre_ck_pnts_dir_DR =  "/data/liqianlin/HDNET_code/training/surr_tiktok_order_model/train_progress_0.2_2_changemodel_dp/model/HDNet"
sec_path='/1920000/'
third_path='1920000'
...
##############################    Inference Code     ##################################
pre_ck_pnts_dir_DR =  "/data/liqianlin/HDNET_code/model/depth_prediction"
...
# tang='/data/liqianlin/Evalation_Hdnet/eva_256'
# test_files = get_test_data_9_channals_tang(tang)
...
for f in range(len(test_files)):
    ...
    X,Z, Z3, DP = read_test_data_9_channals_tang(tang,data_name,IMAGE_HEIGHT,IMAGE_WIDTH)
