...
# gt_depth_path='/data/liqianlin/Evalation_Hdnet/tang_eva_1300/depth_txt/'
gt_depth_path='/data/liqianlin/Evalation_Hdnet/Thuman_test_1300/depth_txt/'
tang=thuman
hunhe=True
for f in range(0,261):
    if f==52:
        continue
    data_name = str(f)+'_10001'
    data_name1 = str(f)+'_20001'
    data_name2 = str(f)+'_30001'
    data_name3 = str(f)+'_40001'
    data_name4 = str(f)+'_50001'
    # print(f)
    # print(f[0])
    ...
    X,Z, Z3,ZB = read_test_data_6_channals_thuman(tang,data_name,IMAGE_HEIGHT,IMAGE_WIDTH)
    X1,Z1, Z31,ZB1 = read_test_data_6_channals_thuman(tang,data_name1,IMAGE_HEIGHT,IMAGE_WIDTH)
    X2,Z2, Z32, ZB2 = read_test_data_6_channals_thuman(tang,data_name2,IMAGE_HEIGHT,IMAGE_WIDTH)
    X3,Z333, Z33, ZB3 = read_test_data_6_channals_thuman(tang,data_name3,IMAGE_HEIGHT,IMAGE_WIDTH)
    X4,Z4, Z34, ZB4 = read_test_data_6_channals_thuman(tang,data_name4,IMAGE_HEIGHT,IMAGE_WIDTH)
